...
// Publish provides a mock function with given fields: ctx, subject, data
func (_m *MockEventPublisher) Publish(ctx context.Context, subject string, data []byte) error {
...
func (_c *MockEventPublisher_Publish_Call) Run(run func(ctx context.Context, subject string, data []byte)) *MockEventPublisher_Publish_Call {
